import 'dart:io';
import 'package:fawaterkom/api/pdf_api.dart';
...
class PdfInvoiceApi {
  ...
  static Future<File> generate(Invoice invoice2) async {
...
/////////////////////////////////////////////
 ...
 /////////////////////////////////////////
  ...
  static pw.Widget buildHeader(Invoice invoice2) => pw.Column(
  ...
  static pw.Widget buildTable(Invoice invoice2) {
    final headers = [
      'المجموع',
      'السعر',
      'الكمية',
...
static pw.Widget buildFooter(Invoice invoice2) => pw.Column(
